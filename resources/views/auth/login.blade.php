<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-center mt-4">
            ...
            <!-- TAMBAHKAN BUTTON LOGIN WITH facebook-->
            <a href="{{ route('oauth.redirect', ['provider' => 'facebook']) }}"
                style="margin-top: 0px !important;background:blueviolet;color: #ffffff;padding: 8px;border-radius:6px;"
                class="items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white text-center uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ms-4">
                <strong><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <!-- END OF BUTTON LOGIN WITH facebook-->

            <!-- TAMBAHKAN BUTTON LOGIN WITH Github-->
            ...
            <!-- END OF BUTTON LOGIN WITH Github-->
        </div>
    </form>
</x-guest-layout>
